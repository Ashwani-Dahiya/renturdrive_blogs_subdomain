            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-c-blue order-card">
                    <div class="card-body">
                        ...
                        <h5 class="text-end text-white"><i class="feather icon-user float-start"></i><span></span>\</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-c-yellow order-card">
                    <div class="card-body">
                        ...
                        <h5 class="text-end text-white"><i class="feather icon-tag float-start"></i><span></span></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
