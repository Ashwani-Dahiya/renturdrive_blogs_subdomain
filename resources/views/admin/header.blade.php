        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    {{-- <li class="nav-item">
                        <a href=""><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Company Details</span></a>
                    </li> --}}
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Blogs</span></a>
                        <ul class="pcoded-submenu">
                            <li><a href="{{ route('adm.add.blog.page') }}">Add Blog</a></li>
                            <li><a href="{{ route('adm.all.blog.page') }}">All Blogs</a></li>
                            <li><a href="{{ route('adm.add.blog.author') }}">Add Blog Author</a></li>
                            <li><a href="{{ route('adm.add.blog.category') }}">Add Blog Category</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
